...
public class AStarRRSSW implements Navigator{
	...
	private int REPULSION_WEIGHTING = 100;		//10 = avoiding a block directly next to it is equivalent to moving 1 tile away
